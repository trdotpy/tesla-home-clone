...
const Account = () => {
    return (
        <div>
            ...
            {/* ---ACCOUNT INFO--- */}
            <div className="flex justify-between items-center py-36 px-8 pb-8">
            ...
            <div className="grid place-items-center">
                ...
                <p className="max-w-sm text-center text-sm leading-6 text-[#393c41]">
                    <span className="text-[#3e6be2] cursor-pointer">
                        Request a Call
                    </span>{' '}
                    to speak with a product specialist, value your trade-in or
                    apply for leasing
                </p>
            </div>
        </div>
